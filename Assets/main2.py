...
BG = pygame.transform.scale(pygame.image.load(os.path.join("SpaceInvaders","Assets", "background_black.png")), (WIDTH, HEIGHT))
...
def main():
    ...
    boss_font = pygame.font.SysFont("comicsans", 100)
